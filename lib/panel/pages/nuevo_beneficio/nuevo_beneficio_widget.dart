...
import 'nuevo_beneficio_model.dart';
export 'nuevo_beneficio_model.dart';

class NuevoBeneficioWidget extends StatefulWidget {
  const NuevoBeneficioWidget({Key? key}) : super(key: key);

  @override
  _NuevoBeneficioWidgetState createState() => _NuevoBeneficioWidgetState();
}

class _NuevoBeneficioWidgetState extends State<NuevoBeneficioWidget> {
  late NuevoBeneficioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NuevoBeneficioModel());
