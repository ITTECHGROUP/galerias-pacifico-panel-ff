...
import 'base_de_datos_model.dart';
export 'base_de_datos_model.dart';

class BaseDeDatosWidget extends StatefulWidget {
  const BaseDeDatosWidget({Key? key}) : super(key: key);

  @override
  _BaseDeDatosWidgetState createState() => _BaseDeDatosWidgetState();
}
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: FlutterFlowChoiceChips(
                                          options: [
                                            ChipData('35 a 40 años'),
                                            ChipData('Wanama'),
                                            ChipData('Juana Lopez'),
                                            ChipData('Clara Ben'),
                                            ChipData('última visita'),
                                            ChipData('Añadir', Icons.add)
                                          ],
                                          onChanged: (val) => setState(() =>
                                              _model.choiceChipsValue =
                                                  val?.first),
                                          selectedChipStyle: ChipStyle(
                                            backgroundColor: Color(0xFF658574),
                                            textStyle:
                                                FlutterFlowTheme.of(context)
                                                    .bodyMedium
                                                    .override(
                      ...
                      child: Container(
                        ...
                        child: StreamBuilder<List<UsersAppRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<UsersAppRecord> dataTableUsersAppRecordList =
                                snapshot.data!;
                            return Container(
