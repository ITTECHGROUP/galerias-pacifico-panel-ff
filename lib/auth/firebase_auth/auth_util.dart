...
DocumentReference? get currentUserReference =>
    loggedIn ? UsersAppRecord.collection.doc(currentUser!.uid) : null;

UsersAppRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : UsersAppRecord.getDocument(UsersAppRecord.collection.doc(uid))
              .handleError((_) {}),
    )
