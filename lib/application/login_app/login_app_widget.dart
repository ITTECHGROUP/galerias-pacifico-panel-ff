...
class _LoginAppWidgetState extends State<LoginAppWidget> {
  ...
  void initState() {
    ...
    _model.mailRegisterController1 ??= TextEditingController();
    _model.mailRegisterController2 ??= TextEditingController();
  }
                          ...
                          children: [
                            Material(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  controller: _model.mailRegisterController1,
                                  autofocus: true,
                                  obscureText: false,
                                  ...
                                  validator: _model
                                      .mailRegisterController1Validator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                          ...
                          children: [
                            Material(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  controller: _model.mailRegisterController2,
                                  autofocus: true,
                                  obscureText: !_model.mailRegisterVisibility,
                                  decoration: InputDecoration(
                                    hintText: 'CONTRASEÑA*',
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                  ...
                                  validator: _model
                                      .mailRegisterController2Validator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                final user = await authManager.signInWithEmail(
                                  context,
                                  _model.mailRegisterController1.text,
                                  _model.mailRegisterController2.text,
                                );
                                if (user == null) {
                                  return;
                                }
                                ...
                                if ((valueOrDefault<bool>(
                                            currentUserDocument?.estadoUser,
                                            false) ==
                                        true) &&
                                    (valueOrDefault(
                                            currentUserDocument
