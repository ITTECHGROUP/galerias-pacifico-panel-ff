...
import 'carga_tus_puntos1_model.dart';
export 'carga_tus_puntos1_model.dart';

class CargaTusPuntos1Widget extends StatefulWidget {
  const CargaTusPuntos1Widget({Key? key}) : super(key: key);

  @override
  _CargaTusPuntos1WidgetState createState() => _CargaTusPuntos1WidgetState();
}

class _CargaTusPuntos1WidgetState extends State<CargaTusPuntos1Widget> {
  late CargaTusPuntos1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CargaTusPuntos1Model());
  }
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 15.0, 0.0, 0.0),
                            child: Text(
                              'Para poder sumar sus puntos tome una foto clara o suba su factura.',
                              textAlign: TextAlign.center,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
