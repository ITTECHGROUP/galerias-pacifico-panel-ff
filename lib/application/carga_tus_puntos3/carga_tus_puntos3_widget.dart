...
import 'carga_tus_puntos3_model.dart';
export 'carga_tus_puntos3_model.dart';

class CargaTusPuntos3Widget extends StatefulWidget {
  const CargaTusPuntos3Widget({Key? key}) : super(key: key);

  @override
  _CargaTusPuntos3WidgetState createState() => _CargaTusPuntos3WidgetState();
}

class _CargaTusPuntos3WidgetState extends State<CargaTusPuntos3Widget> {
  late CargaTusPuntos3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CargaTusPuntos3Model());
  }
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 15.0, 0.0, 0.0),
                            child: Text(
                              'La factura ha sido cargada con éxito y los puntos fueron solicitados. Se verán refjlejados hasta las próximas 72 horas ',
                              textAlign: TextAlign.center,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                final puntosPendientesCreateData =
                                    createPuntosPendientesRecordData(
                                  facturaPico: _model.uploadedFileUrl3,
                                );
                                await PuntosPendientesRecord.collection
                                    .doc()
                                    .set(puntosPendientesCreateData);
