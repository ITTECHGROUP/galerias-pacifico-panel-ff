...
import 'password_app_model.dart';
export 'password_app_model.dart';

class PasswordAppWidget extends StatefulWidget {
  const PasswordAppWidget({Key? key}) : super(key: key);

  @override
  _PasswordAppWidgetState createState() => _PasswordAppWidgetState();
}

class _PasswordAppWidgetState extends State<PasswordAppWidget> {
  late PasswordAppModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PasswordAppModel());
