...
import 'base_de_datos_copy_model.dart';
export 'base_de_datos_copy_model.dart';

class BaseDeDatosCopyWidget extends StatefulWidget {
  const BaseDeDatosCopyWidget({Key? key}) : super(key: key);

  @override
  _BaseDeDatosCopyWidgetState createState() => _BaseDeDatosCopyWidgetState();
}

class _BaseDeDatosCopyWidgetState extends State<BaseDeDatosCopyWidget> {
  late BaseDeDatosCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BaseDeDatosCopyModel());
