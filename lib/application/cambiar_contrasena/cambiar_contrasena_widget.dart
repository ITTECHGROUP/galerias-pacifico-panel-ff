...
class _CambiarContrasenaWidgetState extends State<CambiarContrasenaWidget> {
  ...
  void initState() {
    ...
    _model.cambarEmailController ??= TextEditingController();
  }
                  ...
                  Column(
                    ...
                    children: [
                          ...
                          children: [
                            Material(
                              ...
                              child: Container(
                                ...
                                child: TextFormField(
                                  controller: _model.cambarEmailController,
                                  autofocus: true,
                                  obscureText: false,
                                  ...
                                  validator: _model
                                      .cambarEmailControllerValidator
                                      .asValidator(context),
                                ),
                              ),
                            ),
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            if (_model.cambarEmailController.text != null &&
                                _model.cambarEmailController.text != '') {
                              if (_model.cambarEmailController.text.isEmpty) {
                              ...
                              await authManager.resetPassword(
                                email: _model.cambarEmailController.text,
                                context: context,
                              );
                            } else {
                              await showDialog(
